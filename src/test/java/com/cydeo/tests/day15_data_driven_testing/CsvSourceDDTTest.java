...
public class CsvSourceDDTTest {
    ...
    public void basicAddTest(int num1, int num2, int expSum){
        ...
        System.out.println("num1 " + num1 + " num2 + " + num2 + " exprSum = " + expSum);
    ...
    @CsvSource({"New York City, NY",
                ...
                "San Diego, CA",
                "Baltimore, MD"})
    public void city_and_state_test(String city, String state){
    ...
    given().accept(ContentType.JSON)
            ...
            .and().body("'place name'", equalTo(city)) // ' ' - need put
            .log().all();
